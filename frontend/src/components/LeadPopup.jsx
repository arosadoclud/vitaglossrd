...
export default function LeadPopup() {
  ...
  const handleSubmit = (e) => {
    ...
    const msg = encodeURIComponent(
      `Hola VitaGloss RD! 👋 Soy *${nombre}* y me registré desde la web. Me interesa recibir los *tips exclusivos de cuidado capilar* y mi *10% de descuento en mi primer pedido*.${refTexto} ¡Gracias!`
    )
                  ...
                  <>
                    ...
                    <div className="text-center mb-4">
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-2xl px-4 py-3 text-left space-y-2 mb-3">
                        <p className="text-white/80 text-xs flex items-start gap-2"><span className="text-green-400 mt-0.5 flex-shrink-0">✅</span> <span className="font-bold">Tips exclusivos de cuidado capilar por WhatsApp</span></p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
                      ...
                      <button
                        type="submit"
                        className="w-full bg-green-700 hover:bg-green-800 text-white font-black py-3 rounded-xl transition-all hover:scale-[1.02] flex items-center justify-center gap-2 shadow-lg shadow-green-900/40 mt-1"
                      >
                        ...
                        Sí, quiero los tips + mi descuento
                      </button>
