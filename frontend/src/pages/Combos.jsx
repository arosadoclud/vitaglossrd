              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="flex-1 bg-green-700 hover:bg-green-800 text-white py-4 rounded-2xl font-black text-base transition-all duration-200 hover:scale-[1.02] flex items-center justify-center gap-3 shadow-lg shadow-green-100"
                  >
