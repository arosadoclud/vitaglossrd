          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                ...
                <p className="text-center text-xs text-gray-400 mt-2">Si está disponible, coordinamos total y entrega antes de confirmar.</p>
              </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        {user ? (
                          ...
                          <p className="text-xs text-gray-400 italic">Inicia sesión para ver precio</p>
                        )}
