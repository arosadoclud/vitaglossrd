...
export default function Blog() {
    ...
    jsonLdList: [
      {
        ...
        url: 'https://www.vitaglossrd.com/blog',
        inLanguage: 'es-DO',
        publisher: {
          '@type': 'Organization',
          name: 'VitaGloss RD',
        ...
        blogPost: posts.slice(0, 10).map(p => ({
          '@type': 'BlogPosting',
          headline: p.titulo,
          url: `https://www.vitaglossrd.com/blog/${p.slug}`,
          datePublished: p.fecha,
          dateModified: p.fechaActualizacion || p.fecha,
          description: p.metaDescripcion || p.excerpt,
          keywords: p.tags?.join(', '),
          image: p.imagen ? `https://www.vitaglossrd.com${p.imagen}` : undefined,
          isAccessibleForFree: true,
          author: { '@type': 'Person', name: 'Andy Rosado', url: 'https://www.vitaglossrd.com/sobre-nosotros' },
        })),
      },
      {
        '@context': 'https://schema.org',
      ...
      },
      {
        ...
        '@type': 'BreadcrumbList',
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'Inicio', item: 'https://www.vitaglossrd.com' },
          { '@type': 'ListItem', position: 2, name: 'Blog',   item: 'https://www.vitaglossrd.com/blog' },
        ],
      },
      {
        '@context': 'https://schema.org',
  ...
  return (
    ...
    <div className="bg-white min-h-screen">
      ...
      {/* ── FILTROS ── */}
      <div className="sticky top-[60px] sm:top-[64px] z-10 bg-white border-b border-gray-100 shadow-sm">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <Motion.button
            ...
            className="fixed bottom-24 right-5 z-40 bg-primary text-white w-11 h-11 rounded-full shadow-lg shadow-primary/30 flex items-center justify-center hover:bg-secondary transition-colors"
          >
